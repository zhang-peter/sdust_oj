...
class Submission(DeclarativeBase):
    ...
    code_type = Column("code_type", Integer, nullable=False, default=0),
    code = Column("code", Text, nullable=False, default="")
    ...
    #def __str__(self):
        #print "<id:%d,sub_time:%s,status:%s> " %(self.id,self.sub_time,self.status)
    def __len__(self):
        return 1